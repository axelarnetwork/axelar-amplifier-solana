...
//
// Anchor/Borsh serialization for payloads
//
...
//
// Anchor/Borsh serialization for accounts
//
...
impl AnchorDeserialize for SolanaAccountRepr {
...
mod tests {
    ...
    fn solana_account_repr_round_trip_borsh() {
        ...
        let _repr2: SolanaAccountRepr = BorshDeserialize::try_from_slice(&repr_encoded).unwrap();
    }
    ...
    fn account_serialization_borsh() {
        ...
        let decoded: Vec<SolanaAccountRepr> = BorshDeserialize::try_from_slice(&encoded).unwrap();
