...
pub fn make_deploy_remote_canonical_token_instruction(
    payer: Pubkey,
    token_mint: Pubkey,
    destination_chain: String,
    gas_value: u64,
    ...
    Instruction,
    crate::accounts::DeployRemoteCanonicalInterchainToken,
) {
    ...
    (
        Instruction {
            ...
            data: crate::instruction::DeployRemoteCanonicalInterchainToken {
                destination_chain,
                gas_value,
            }
            .data(),
