...
//     // Step 6: Create the interchain transfer using the deployed token
//     let transfer_amount = 1_000_000u64;
//     let destination_pubkey = Pubkey::new_unique(); // Transfer to same user for simplicity
//     let destination_address = destination_pubkey.to_bytes().to_vec(); // 32 bytes for Solana Pubkey
//     let source_address = "ethereum_address_123".to_owned(); // some valid UTF-8 string
...
//     let ata_create_ix = spl_associated_token_account::instruction::create_associated_token_account(
//         &payer,
//         &destination_pubkey,
//         &token_mint_pda,
//         &spl_token_2022::id(),
...
//     let ata_create_result = mollusk.process_instruction(
//         &ata_create_ix,
//         &[
//             (payer, payer_account.clone()),
//             (destination_ata, new_empty_account()),
//             (token_mint_pda, token_mint_account_after_deploy.clone()),
//         ],
//     );
