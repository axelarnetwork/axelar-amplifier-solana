...
export type MessageExecutedEventArgs = MessageExecutedEvent;

export function getMessageExecutedEventEncoder(): Encoder<MessageExecutedEventArgs> {
...
export function getMessageExecutedEventDecoder(): Decoder<MessageExecutedEvent> {
...
export function getMessageExecutedEventCodec(): Codec<
  MessageExecutedEventArgs,
  MessageExecutedEvent
> {
  return combineCodec(
    getMessageExecutedEventEncoder(),
    getMessageExecutedEventDecoder()
  );
}
