...
use solana_axelar_gas_service::instruction;
use solana_axelar_gas_service_legacy::instructions as v1_instructions;
...
fn test_v1_treasury_compatibility() {
    ...
    use solana_axelar_gas_service_legacy::state::Config;
